...
@section('title', 'Create Group Reservation')
@section('breadcrumb')
               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control is-invalid" name="deposit" placeholder="Deposit..." value="{{ old('deposit') }}" autocomplete="off" required>
                        <div class="invalid-feedback">
         ...
         <div class="col-md-12">
            <div class="card card-outline card-primary">
               ...
               <div class="card-body">
                  ...
                  <input type="text" name="contactPerson" placeholder="Name person..." class="form-control @error('namePerson') is-invalid @enderror" value="{{ old('namePerson') }}">
                  @error('contactPerson')
                  <div class="invalid-feedback">
                     {{ $message }}
                  </div>
         ...
         <div class="col-md-12">
            <div class="card card-outline card-primary">
               <div class="card-header">
                  ...
                  <a href="#" class="px-1 ml-2 btn btn-warning btn-xs" onclick="addMeals()"><i class="fa fa-plus px-1"></i>Meal arragement</a>
                  <div class="card-tools">
                     <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                     </button>
                  </div>
...
<script>
   ...
   function addMeals() {
      document.querySelector('#mealsContent').insertAdjacentHTML(
         'afterbegin',
         `<div class="row">
            ...
            <div class="col-sm-4" id="3">
               ...
               <a href="#" class="btn btn-danger" onclick="removeMealsArragement(this)" style="display:inline"><i class="fa fa-times"></i></a>
            </div>
         </div>`
      )
   }

   function removeMealsArragement(input){
      $('#1').remove();
      $('#2').remove();
      $('#3').remove();
   }
