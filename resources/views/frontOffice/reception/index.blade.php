...
@section('title', 'Registration guest')

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
   <li class="breadcrumb-item"><a href="">Home</a></li>
   <li class="breadcrumb-item active">Data Registration guest</li>
</ol>
@endsection
...
<script>
   ...
   $(function() {
      ...
      $('#dataTable').DataTable({
         ...
         "responsive" : true,
         "autoWidth" : true,
         ajax: '{{ route('reception.data.registrations') }}',
         columns : [
            {data: 'DT_RowIndex'},
            {data: 'guestName'},
            {data: 'arrivaleDate'},
